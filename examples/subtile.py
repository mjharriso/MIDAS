...
ax1.contour(xax0,yax0,sq(S.ROSE),[0.0,0.1],colors='k',linewidth=2.0)
...
ax2.contour(xax0,yax0,sq(S.ROSE),[0.0,0.1],colors='k',linewidth=2.0)
ax2.contour(xax,yax,sq(R.mean),[0.0,0.1],colors='m',linewidth=2.0)
...
ax3.contour(xax0,yax0,sq(S.ROSE),[0.0,0.1],colors='k',linewidth=2.0)
ax3.contour(xax,yax,sq(R.max),[0.0,0.1],colors='m',linewidth=2.0)
...
ax4.contour(xax0,yax0,sq(S.ROSE),[0.0,0.1],colors='k',linewidth=2.0)
ax4.contour(xax,yax,sq(R.mean),[0.0,0.1],colors='m',linewidth=2.0)
