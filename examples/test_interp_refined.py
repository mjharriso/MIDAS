...
grid_out = generic_grid(lon=lon,lat=lat,is_latlon=True)
grid=generic_grid('http://oceanwatch.pfeg.noaa.gov/thredds/dodsC/satellite/AA/ssta/8day',var='AAssta')
...
R=S.horiz_interp_refined(field='sst',target=grid_out)
